...
px1 = r_octagon1*cosd( (0:60:300)' + 30 );
py1 = r_octagon1*sind( (0:60:300)' + 30 );
px2 = r_octagon2*cosd( (0:60:300)' + 30 );
py2 = r_octagon2*sind( (0:60:300)' + 30 );
...
% end
for i = 1:6
    obj = obj+circle(px1(i), py1(i),r_circle, 5);
    obj = obj+circle(px2(i), py2(i),r_circle*1.5, 5);
end
imagesc(x, x, obj)
