lat_vec1 = [4.5, 0];
lat_vec2 = [0, 4.5];
percent_vacancies = 0.005;
num_sites = 20; % num rows + cols
strain_range = 2;
...
vacancy_ind = randi(num_atoms, num_vacancies,1);
...
figure
hold on
scatter(coords(:,1),coords(:,2),'filled','blue');
scatter(strained_coords(:,1),strained_coords(:,2),'filled','red')
hold off
